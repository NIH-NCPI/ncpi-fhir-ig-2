# BAM or CRAM file profile - NCPI FHIR Implementation Guide v2 v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BAM or CRAM file profile**

## Resource Profile: BAM or CRAM file profile 

| | |
| :--- | :--- |
| *Official URL*:https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-bamcram | *Version*:0.2.0 |
| Draft as of 2026-03-09 | *Computable Name*:NcpiBAMCRAM |

 
BAM or CRAM file profile 

### BAM/CRAM File Metadata
...
* Examples for this Profile: [Observation/gregor-example-metadata](Observation-gregor-example-metadata.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ncpi-fhir-implementation-guide-v2|current/StructureDefinition/ncpi-bamcram)
...
Other representations of profile: [CSV](StructureDefinition-ncpi-bamcram.csv), [Excel](StructureDefinition-ncpi-bamcram.xlsx), [Schematron](StructureDefinition-ncpi-bamcram.sch) 
