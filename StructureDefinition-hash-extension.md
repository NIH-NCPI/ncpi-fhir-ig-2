...
| Draft as of 2026-03-09 | *Computable Name*:HashExtension |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/hash-value"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/hash-type"]
      }]
    },
    {
      "id" : "Extension.url",
