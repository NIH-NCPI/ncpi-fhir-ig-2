# VCF or gVCF file profile - NCPI FHIR Implementation Guide v2 v0.2.0
...
| Draft as of 2026-01-13 | *Computable Name*:NcpiVCF |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ncpi-fhir-implementation-guide-v2|current/StructureDefinition/ncpi-vcf)
...
Other representations of profile: [CSV](StructureDefinition-ncpi-vcf.csv), [Excel](StructureDefinition-ncpi-vcf.xlsx), [Schematron](StructureDefinition-ncpi-vcf.sch) 
...
```json
{
  ...
  "id" : "ncpi-vcf",
  "url" : "https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-vcf",
  "version" : "0.2.0",
  "name" : "NcpiVCF",
