...
| Draft as of 2026-03-09 | *Computable Name*:PartOfStudy |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-research-study"]
      }]
    }]
  }
}
