...
* relatedArtifact[0].label = "dbGaP Study Name"
* relatedArtifact[0].display = "Childhood Cancer Data Initiative (CCDI): Molecular Characterization across Pediatric Brain Tumors and Other Solid and Hematologic Malignancies for Research, Diagnostic, and Precision Medicine"
* relatedArtifact[1].type = #documentation
* relatedArtifact[1].label = "acronym"
* relatedArtifact[1].display = "CBTN"
* relatedArtifact[2].type = #documentation
* relatedArtifact[2].label = "acronym"
* relatedArtifact[2].display = "PBTA-CBTN"
* relatedArtifact[3].type = #documentation
* relatedArtifact[3].label = "Legacy Study Name"
* relatedArtifact[3].display = "Pediatric Brain Tumor Atlas: CBTTC"
* relatedArtifact[4].type = #documentation
* relatedArtifact[4].label = "Website"
* relatedArtifact[4].url = "https://cbtn.org/"
* relatedArtifact[5].type = #documentation
* relatedArtifact[5].label = "enrollmentCriteria"
* relatedArtifact[5].display = "Pediatric and AYA patients diagnosed with a central nervous system tumor, solid tumor, or hematologic malignancy."
* relatedArtifact[6].type = #citation 
* relatedArtifact[6].label = "Publication"
* relatedArtifact[6].url = "https://cbtn.org/publications"
* status = #completed
...
* extension[research-study-associated-party][0].extension[name].valueString = "Adam C. Resnick"
* extension[research-study-associated-party][0].extension[role].valueCodeableConcept = http://hl7.org/fhir/research-study-party-role#primary-investigator
* extension[research-study-associated-party][0].extension[party].valueReference = Reference(kf-research-study-personnel-role-pi-x01)
* extension[research-study-associated-party][1].extension[name].valueString = "Allison P. Heath"
* extension[research-study-associated-party][1].extension[role].valueCodeableConcept = http://hl7.org/fhir/research-study-party-role#primary-investigator
* extension[research-study-associated-party][1].extension[party].valueReference = Reference(kf-research-study-personnel-role-pi)
* extension[research-study-associated-party][2].extension[name].valueString = "Jennifer Mason"
* extension[research-study-associated-party][2].extension[role].valueCodeableConcept = http://hl7.org/fhir/research-study-party-role#study-director
* extension[research-study-associated-party][2].extension[party].valueReference = Reference(kf-research-study-personnel-role-op-lead)
