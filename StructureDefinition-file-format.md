# The file format used - NCPI FHIR Implementation Guide v2 v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **The file format used**

## Extension: The file format used 

| | |
| :--- | :--- |
| *Official URL*:https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/file-format | *Version*:0.2.0 |
| Draft as of 2026-01-13 | *Computable Name*:FileFormat |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ncpi-fhir-implementation-guide-v2|current/StructureDefinition/file-format)
...
Other representations of profile: [CSV](StructureDefinition-file-format.csv), [Excel](StructureDefinition-file-format.xlsx), [Schematron](StructureDefinition-file-format.sch) 
