# MAF (Somatic Mutation) file profile - NCPI FHIR Implementation Guide v2 v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MAF (Somatic Mutation) file profile**

## Resource Profile: MAF (Somatic Mutation) file profile 

| | |
| :--- | :--- |
| *Official URL*:https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-maf | *Version*:0.2.0 |
| Draft as of 2026-01-13 | *Computable Name*:NcpiMAF |

 
MAF (Somatic Mutation) file profile 

### MAF (Somatic Mutation) File Metadata
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ncpi-fhir-implementation-guide-v2|current/StructureDefinition/ncpi-maf)
...
Other representations of profile: [CSV](StructureDefinition-ncpi-maf.csv), [Excel](StructureDefinition-ncpi-maf.xlsx), [Schematron](StructureDefinition-ncpi-maf.sch) 
...
```json
{
  ...
  "id" : "ncpi-maf",
  "url" : "https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-maf",
  "version" : "0.2.0",
  "name" : "NcpiMAF",
